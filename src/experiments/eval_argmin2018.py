...
if __name__ == '__main__':
    ...
    for (segmentation, relationset), conditions in settings.iteritems():
        evaluate_setting(lang, segmentation, relationset, conditions, corpus_id="m112en")
    ...
    for (segmentation, relationset), conditions in settings.iteritems():
        evaluate_setting(lang, segmentation, relationset, conditions, corpus_id="m112en_part2")
